...
namespace ClinicalTrialApp.Tests.Features.ClinicalTrials.Commands
{
    public class UploadTrialDataCommandHandlerTests
    {
        private readonly Mock<IClinicalTrialService> _serviceMock;
        ...
        {
            _serviceMock = new Mock<IClinicalTrialService>();
            _loggerMock = new Mock<ILogger<UploadTrialDataCommandHandler>>();
            _handler = new UploadTrialDataCommandHandler(_serviceMock.Object, _loggerMock.Object);
        }

        [Fact]
        public async Task Handle_WithValidFile_ReturnsSuccess()
        {
            // Arrange
            ...
            _serviceMock.Setup(x => x.ProcessTrialDataAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task Handle_WithInvalidFile_ReturnsFailure()
        {
            // Arrange
